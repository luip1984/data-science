...
COPY trips(id,listing_url,scrape_id,last_scraped,name,summary,space,
...
FROM 'C:\Export\Thinkful\Docs\Unit 1\Lesson 2\Project 6\listings.csv' DELIMITER ',' CSV HEADER;